...
# notes_bp = Blueprint("notes", __name__, url_prefix="/<int:wanted_villager_id>/notes")
...
# # @jwt_required()
# def create_note(wanted_villager_id):
#     body_data = request.get_json()
#     # fetch the wanted villager with that particular id - wanted_villager_id
#     stmt = db.select(WantedVillagers).filter_by(id=wanted_villager_id)
...
#             # wanted_villager=wanted_villager_id,
...
#         return {"error": f"Wanted Villager with id {wanted_villager_id} not found"}, 404

# Delete Note - /wanted_villagers/wanted_vilager_id/notes/notes_id
...
# @jwt_required()
# def edit_note(wanted_villager_id, note_id):
